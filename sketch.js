...
function setup() {
  ...
  ground1 = new Ground(600,295,200,20);
  ground2 = new Ground(900,205,200,20);
  ground3 = new Ground(750, 400, 1500, 40)
  ...
  sling = new Chain(this.ball,{x:150, y:280});
